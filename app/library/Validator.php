...
class Validator {
    ...
    /**
     * 用户名校验（用户名正则，4到16位（字母，数字，下划线，减号）
     *
     * @access public
     * @param string
     * @return boolean
    ...
    public static function password($str){
        return preg_match("/^.*(?=.{6,})(?=.*\d)(?=.*[A-Za-z]).*$/", $str);
    }
     ...
     * @return int
     */
    public static function menu_mvc($str){
     ...
     * @return int
     */
    public static function menu_url($str){
